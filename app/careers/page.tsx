              ...
              <form onSubmit={handleApply} className="p-6 space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <PhoneInput value={formData.phone} onChange={(v) => setFormData(f => ({ ...f, phone: v }))} />
                  </div>
                </div>
                ...
                <button type="submit"
                  disabled={submitting || !formData.name || !formData.email || !isValidPhone(formData.phone) || !formData.experience || !resumeFile}
