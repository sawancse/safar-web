export const metadata = { title: 'Accessibility Statement | BhramanKaro' };
    ...
    <div className="min-h-screen bg-white">
      <section className="bg-[#003B95] text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="mt-3 text-white/80">Making BhramanKaro usable for everyone.</p>
        </div>
      </section>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 space-y-8">
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3">Our Commitment</h2>
          <p className="text-gray-600 leading-relaxed">BhramanKaro is committed to ensuring digital accessibility for people with disabilities. We are continually improving the user experience for everyone and applying relevant accessibility standards.</p>
        </section>
        <section>
        ...
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">We welcome your feedback on the accessibility of BhramanKaro. If you encounter any barriers, please contact us at <a href="mailto:accessibility@bhramankaro.com" className="text-[#003B95] hover:underline">accessibility@bhramankaro.com</a>.</p>
        </section>
      </div>
    </div>
  );
