...
const CATEGORIES = [
  ...
  'WATER', 'HOUSEKEEPING', 'FOOD_MEALS', 'AC_COOLING',
  'ROOM_SERVICE', 'BREAKFAST', 'LUNCH', 'DINNER',
  'TOWELS_LINEN', 'MINIBAR', 'EXTRA_BED', 'WAKE_UP_CALL',
  'CHECKOUT_EXTENSION', 'CONCIERGE', 'LUGGAGE', 'TRANSPORT',
  'OTHER',
];
