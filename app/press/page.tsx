export const metadata = { title: 'Press Center | BhramanKaro' };
    ...
    <div className="min-h-screen bg-white">
      <section className="bg-[#003B95] text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="mt-3 text-white/80">News, updates, and media resources from BhramanKaro.</p>
        </div>
      </section>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 space-y-10">
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-3">About BhramanKaro</h2>
          <p className="text-gray-600 leading-relaxed">BhramanKaro is India's first zero-commission property rental marketplace. Founded in 2026, we connect travellers with verified stays, home cooks, and local experiences across 50+ Indian cities. Our mission is to make travel fair for hosts and affordable for guests.</p>
        </section>
        <section>
        ...
        <section>
          ...
          <div className="space-y-4">
            {[
              { date: 'April 2026', title: 'BhramanKaro launches Cooks & Chefs marketplace', desc: 'Hire verified home cooks and event caterers directly through the platform.' },
